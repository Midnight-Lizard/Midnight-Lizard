...
function initPopupSettings(settings)
{
    if (settings)
    {
        ...
        version.href = "../ui/change-log.html?" + version.innerText;
        let newVersion = document.getElementById("new-version");
        newVersion.href = version.href;
        newVersion.cbIgnore = true;
