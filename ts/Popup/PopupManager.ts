...
namespace MidnightLizard.Popup
{
    ...
    class PopupManager
    {
        ...
        constructor(
            ...
            private readonly _webColorConverter: MidnightLizard.Colors.IColorToRgbaStringConverter)
        {
        ...
        {
            const to100 = (color: Colors.HslaColor) =>
            {
                color.lightness *= 100;
            ...
            const
                black = to100(new Colors.HslaColor(0, 0, 0, 1)),
                white = to100(new Colors.HslaColor(0, 0, 1, 1)),
                gray = to100(new Colors.HslaColor(0, 0, 0.5, 1));
            const convert = (webColor: string) =>
                to100(Colors.RgbaColor.toHslaColor(Colors.RgbaColor
        ...
        })
        {
            ...
            Object.keys(genColors).forEach(color =>
                ...
                Colors.RgbaColor.toHexColorString((genColors as any)[color]));
        ...
        {
            const white = Colors.RgbaColor.White, black = Colors.RgbaColor.Black,
                gray = Colors.RgbaColor.Gray, link = Colors.RgbaColor.Link;
